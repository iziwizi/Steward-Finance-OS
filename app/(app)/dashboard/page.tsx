...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* ============================================================ */}
      {/* MOBILE DASHBOARD (FIGMA-INSPIRED MATURE FINTECH EXPERIENCE) */}
      {/* ============================================================ */}
      <div className="space-y-4 md:hidden">
        {/* 1. Primary Green Financial Summary Card */}
        <div className="rounded-2xl bg-[#135d47] p-5 text-white shadow-sm">
          <div>
        ...
        <div className="grid grid-cols-4 gap-2 pt-1">
          ...
          <Link
            ...
            className="group flex flex-col items-center gap-1.5 text-center"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200/60 shadow-2xs transition-transform active:scale-95 group-hover:bg-emerald-100">
          ...
          <Link
            ...
            className="group flex flex-col items-center gap-1.5 text-center"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-rose-50 text-rose-700 border border-rose-200/60 shadow-2xs transition-transform active:scale-95 group-hover:bg-rose-100">
          ...
          <Link
            ...
            className="group flex flex-col items-center gap-1.5 text-center"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-purple-50 text-purple-700 border border-purple-200/60 shadow-2xs transition-transform active:scale-95 group-hover:bg-purple-100">
        ...
        {/* 3. Authoritative Dynamic Celebration / Encouragement Card */}
        <div className="flex flex-col gap-2.5 rounded-xl border border-amber-200 bg-amber-50/90 p-4 text-left shadow-xs">
          <div className="flex items-start gap-2.5 min-w-0">
            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-amber-100/90 text-amber-700 mt-0.5">
              <Sparkles className="h-3.5 w-3.5" />
            </div>
            <div className="min-w-0 space-y-0.5">
              <p className="font-bold text-zinc-900 text-xs">{encouragement.title}</p>
              <p className="text-xs text-zinc-600 leading-relaxed">{encouragement.message}</p>
            </div>
          </div>
          <div className="pl-9.5 pt-0.5">
            <Link
              href="/allocations"
        ...
        <div className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-sm">
          ...
          <div className="mt-3 space-y-3">
            {data.budgetHealth.length === 0 ? (
              <p className="text-xs text-zinc-400 py-1">No active envelopes configured.</p>
            ) : (
              ...
              recentTransactions.slice(0, 4).map((tx) => (
                <div key={tx.id} className="flex items-center justify-between py-2.5 text-xs">
                  <div className="min-w-0 pr-2">
                    <p className="font-semibold text-zinc-900 truncate">{tx.description}</p>
          ...
          <div className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-sm">
            ...
            <div className="mt-3 space-y-2.5">
              {data.goals.slice(0, 2).map((g) => {
                ...
                return (
                  <div key={g.id} className="rounded-lg border border-zinc-100 bg-zinc-50/70 p-2.5">
                    <div className="flex items-start justify-between text-xs font-bold text-zinc-900">
                      <span>{g.name}</span>
      ...
      {/* ============================================================ */}
      {/* DESKTOP DASHBOARD (APPROVED FIGMA-INSPIRED DESKTOP LAYOUT)   */}
      {/* ============================================================ */}
