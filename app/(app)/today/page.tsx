...
export default async function TodayPage() {
  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      {/* ============================================================ */}
      {/* PRIMARY: Check-In Form (TodaysDecisions component)           */}
      {/* ============================================================ */}
      <TodaysDecisions
      ...
      {/* ============================================================ */}
      {/* SECONDARY: Pending Obligations & Upcoming Bills              */}
      {/* ============================================================ */}
      {(titheAlloc || otherPending.length > 0 || upcomingBills.length > 0) && (
        <div className="space-y-3">
          <p className="text-[11px] font-bold uppercase tracking-wider text-zinc-400 px-0.5">
            Today&apos;s Obligations
          </p>
